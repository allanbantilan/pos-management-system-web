...
class ReceiptPolicy
{
    ...
    public function view(mixed $authUser, Receipt $receipt): bool
    {
        return $this->can($authUser, 'can view dashboard analytics');
    }
    ...
    public function update(mixed $authUser, Receipt $receipt): bool
    {
        return false;
    }

    public function delete(mixed $authUser, Receipt $receipt): bool
    {
        return false;
    }
    ...
    public function forceDelete(mixed $authUser, Receipt $receipt): bool
    {
        return false;
    }
    ...
    public function restore(mixed $authUser, Receipt $receipt): bool
    {
        return false;
    }
    ...
    public function replicate(mixed $authUser, Receipt $receipt): bool
    {
        return false;
    }
